...
globalVariables(
  names = c(
    ...
    "Cell annotation", "cell_annotation", "cell_id", "cherry_gradient",
    "cluster", "COa", "COb", "column", "comp_id", "component", "component_n_post_filtering",
    "component_n_pre_filtering", "condition", "contrast", "control_outlier",
    "control_perc", "control_score", "coreness", "deduped_valid_reads",
    "Default", "degree", "dispersion_gini", "dispersion_outlier",
    "dispersion_tau", "doublet_prediction", "Edge count after recovery",
    ...
    "fload", "frac", "fraction_graph_reads", "fraction_nodes_in_largest_component_post_recovery",
    ...
    "marker_i", "max_size_theshold", "max_slope", "mean_coreness",
    "mean_join_count_z", "mean_log2_ratio", "Median dangling nodes [%]",
    "Median mean coreness", "Median percent control markers", "Median reads per cell [thousands]",
    ...
    "nodes", "normcount", "number_of_umis_removed", "output", "package",
    "pct", "percent", "percent_dangling_nodes", "percent_nodes",
    "percent_nodes_in_largest_post", "percent_nodes_in_largest_pre",
    "percent_well_connected_nodes", "plot_data", "QC Cell\nfiltering",
    "QC Cell filtering", "ratio", "reads_in_component", "reads_per_component",
    "removed_total", "Sample ID", "sample_alias", "sample_component",
    "sample_frac", "saturation", "selected_sample", "seurat_clusters",
    "size_outlier", "slope", "stage", "stage_i", "top_markers", "top3_fraction",
    "top5_fraction", "total_edges_in", "total_reads", "type", "umi1",
    "umi2", "V1", "V2", "valid_reads", "valid_reads_saturation",
